...
import "@/styles/components/com.novice.scss";
import { useUpdateEffect } from "@/utils/Mix";
...
function Novice({ stepInfos, onClose = () => { } }) {
    ...
    return (open && <Popover open={true} className="paper-novice-popover">

...
function StepInputDemo() {
  ...
  return (
    <div className="demo-page">
      ...
      <DemoSection title="基础用法" description="默认步长为 1，最小值为 0">
      ...
      <DemoSection title="设置最小值和最大值" description="通过 min 和 max 属性限制数值范围">
        <div className="demo-row">
      ...
      <DemoSection title="自定义步长" description="通过 step 属性设置每次增减的步长">
      ...
      <DemoSection title="实际应用示例" description="在实际场景中使用步进输入">
      ...
      <DemoSection title="边界测试" description="测试最小值和最大值边界情况">
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          <div className="demo-row">

...
function RangeInputDemo() {
  ...
  return (
    <div className="demo-page">
      ...
      <DemoSection title="基础用法" description="默认范围 0-100，步长 1">
      ...
      <DemoSection title="自定义范围" description="通过 min 和 max 属性设置数值范围">
        <div className="demo-row">
      ...
      <DemoSection title="小数精度" description="支持小数值和自定义精度">
        <div className="demo-row">
      ...
      <DemoSection title="带单位" description="通过 unit 属性添加单位显示">
      ...
      <DemoSection title="禁用状态" description="通过 disabled 属性禁用组件">
        <div className="demo-row">
          <RangeInput value={50} onInput={() => {}} disabled />
        </div>
      </DemoSection>

      <DemoSection title="交互方式" description="支持多种交互方式">
      ...
      <DemoSection title="实际应用示例" description="在实际场景中使用范围输入">

...
function NoviceDemo() {
  ...
  const stepInfos: [HTMLElement | null, string][] = [
    [step1Ref.current, "<h3>欢迎使用！</h3><p>这是一个新手引导组件，可以帮助用户快速了解产品功能。</p>"],
    [step2Ref.current, "<h3>步骤一</h3><p>这是第一个功能点，点击这里可以执行某个操作。</p>"],
    [step3Ref.current, "<h3>步骤二</h3><p>这是第二个功能点，用于配置相关设置。</p>"],
    [step4Ref.current, "<h3>完成！</h3><p>恭喜你完成了新手引导，现在可以开始使用了。</p>"],
  ];
        ...
        <div className="demo-example">
          <div style={{ position: "relative", minHeight: "400px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem", padding: "2rem" }}>
              <div ref={step1Ref} style={{ padding: "1rem", background: "#e3f2fd", borderRadius: "4px", border: "2px solid #1976d2" }}>
                <h4 style={{ margin: "0 0 0.5rem" }}>功能区域 A</h4>
                <p style={{ margin: 0 }}>这是一个重要的功能区域</p>
              </div>

              <div ref={step2Ref} style={{ padding: "1rem", background: "#f3e5f5", borderRadius: "4px", border: "2px solid #9c27b0" }}>
                <h4 style={{ margin: "0 0 0.5rem" }}>功能区域 B</h4>
                <p style={{ margin: 0 }}>这里可以进行其他操作</p>
              </div>

              <div ref={step3Ref} style={{ padding: "1rem", background: "#e8f5e9", borderRadius: "4px", border: "2px solid #4caf50" }}>
                <h4 style={{ margin: "0 0 0.5rem" }}>功能区域 C</h4>
                <p style={{ margin: 0 }}>配置相关设置</p>
              </div>

              <div ref={step4Ref} style={{ padding: "1rem", background: "#fff3e0", borderRadius: "4px", border: "2px solid #ff9800" }}>

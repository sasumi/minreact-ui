...
function PopoverDemo() {
    ...
    return (
        <div className="demo-page">
            ...
            <DemoSection title="基础用法" description="通过 open 和 onOpenChange 控制 Popover 的显示">
            ...
            <DemoSection title="不同弹出方向" description="通过 side 属性设置弹出方向">
            ...
            <DemoSection title="偏移距离" description="通过 sideOffset 属性设置弹出层与触发器的距离">
            ...
            <DemoSection title="复杂内容" description="Popover 中可以包含任意内容">
            ...
            <DemoSection title="列表菜单" description="使用 Popover 创建下拉菜单">
                <Popover>
                    <Popover.Trigger>
            ...
            <DemoSection title="Popover.Anchor 定位锚点" description="使用 Popover.Anchor 将 Popover 定位到任意元素">
                <Popover>
                    <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                        <Popover.Trigger>

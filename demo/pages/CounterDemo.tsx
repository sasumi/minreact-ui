...
function CounterDemo() {
    ...
    return (
        <div className="demo-page">
            ...
            <DemoSection title="文本域计数" description="支持 textarea 元素的字符计数">
                <textarea
                    ref={setInputRef4}
                    placeholder="请输入多行文字..."
            ...
            <DemoSection title="实际应用示例" description="在表单中使用字符计数器">
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        alert("表单提交！");

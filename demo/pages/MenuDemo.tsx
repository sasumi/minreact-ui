import { ComboboxMenu, DropdownMenu, Menu, MenuEntry, MenuItemDivider, Select } from "../../src/components/Menu";
...
function MenuDemo() {
    ...
    const TestMenuItems: MenuEntry[] = [
        ...
        MenuItemDivider,
        { label: "菜单项5", value: "item5", title: "这个是菜单项5" },
        { label: "菜单项6", value: "item6", title: "这个是菜单项6" },
        { label: "菜单项7", value: "item7", title: "这个是菜单项7" },
        { label: "菜单项8", value: "item8", title: "这个是菜单项8" },
        { label: "菜单项9", value: "item9", title: "这个是菜单项9" },
        { label: "菜单项10", value: "item10", title: "这个是菜单项10" },
        { label: "菜单项11", value: "item11", title: "这个是菜单项11" },
        { label: "菜单项12", value: "item12", title: "这个是菜单项12" },
        { label: "菜单项13", value: "item13", title: "这个是菜单项13" },
    ];

    const TestMenuItemsWithIcon: MenuEntry[] = [

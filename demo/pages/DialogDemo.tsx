import Dialog, { showCustomDialog, DIALOG_SIZE_SMALL, DIALOG_SIZE_NORMAL, DIALOG_SIZE_LARGE } from "@/components/Dialog";
    ...
    <div className="demo-page">
      ...
      <div className="demo-section">
        ...
        <div className="demo-example">
          ...
          <Dialog open={open1} setOpen={setOpen1} title="基础对话框">
            <div style={{ padding: "1rem" }}>
              <p>这是一个基础的对话框内容</p>
              <p>可以包含任何 React 组件</p>
            </div>
      ...
      <div className="demo-section">
        ...
        <div className="demo-example">
          <div className="demo-row">
            <PrimaryButton onClick={() => showCustomDialog({ title: "小尺寸", contentNode: <div style={{ padding: "1rem" }}>小尺寸对话框</div>, size: DIALOG_SIZE_SMALL })}>
              小尺寸 (24em)
            </PrimaryButton>
            <PrimaryButton onClick={() => showCustomDialog({ title: "普通尺寸", contentNode: <div style={{ padding: "1rem" }}>普通尺寸对话框</div>, size: DIALOG_SIZE_NORMAL })}>
              普通尺寸 (32em)
            </PrimaryButton>
            <PrimaryButton onClick={() => showCustomDialog({ title: "大尺寸", contentNode: <div style={{ padding: "1rem" }}>大尺寸对话框</div>, size: DIALOG_SIZE_LARGE })}>
              大尺寸 (60em)
            </PrimaryButton>
          </div>
        </div>
      ...
      <div className="demo-section">
        ...
        <p className="demo-section-description">通过 topCloseButton={false} 隐藏右上角关闭按钮</p>
        <div className="demo-example">
          <PrimaryButton onClick={() => setOpen2(true)}>打开对话框</PrimaryButton>
          <Dialog open={open2} setOpen={setOpen2} title="无关闭按钮" topCloseButton={false}>
            <div style={{ padding: "1rem" }}>
              <p>此对话框没有右上角的关闭按钮</p>
      ...
      <div className="demo-section">
        ...
        <div className="demo-example">
          ...
          <Dialog open={open3} setOpen={setOpen3} title="长内容对话框" maxHeight="400px">
            <div style={{ padding: "1rem" }}>

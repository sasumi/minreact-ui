...
function PaginationDemo() {
  ...
  return (
    <div className="demo-page">
      ...
      <DemoSection title="不同每页条数" description="通过 pageSize 属性设置每页显示的条数">
        <div style={{ marginBottom: "1.5rem" }}>
      ...
      <DemoSection title="禁用状态" description="通过 disabled 属性禁用分页操作">
        <Pagination page={5} pageSize={10} total={100} disabled onChange={() => {}} />
        <p style={{ marginTop: "1rem", color: "#666" }}>禁用状态下无法切换页码</p>
      </DemoSection>

      <DemoSection title="页码跳转" description="点击页码信息可以快速跳转到指定页">
      ...
      <DemoSection title="边界情况" description="测试首页、末页和单页的情况">
        <div style={{ marginBottom: "1.5rem" }}>
      ...
      <DemoSection title="实际应用示例" description="在列表数据中使用分页">

...
function ToastDemo() {
    ...
    return (
        <div className="demo-page">
            ...
            <DemoSection title="基础用法" description="四种基础消息类型">
            ...
            <DemoSection title="加载提示" description="显示长时间操作的加载状态">
                <div className="demo-row">
            ...
            <DemoSection title="自定义消息内容" description="可以传入任意文本作为消息内容">
                <div className="demo-row">
            ...
            <DemoSection title="自定义持续时间" description="通过 duration 参数控制显示时长（毫秒）">
                <div className="demo-row">
            ...
            <DemoSection title="回调函数" description="消息关闭后执行回调函数">
                <PrimaryButton
                    onClick={() =>
            ...
            <DemoSection title="手动关闭" description="使用 Toast.hideToast 手动关闭指定的提示">
                <div className="demo-row">
                    <PrimaryButton
                        onClick={() => {
            ...
            <DemoSection title="实际应用场景" description="常见的使用场景示例">

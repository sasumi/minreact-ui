...
function ImageDemo() {
    ...
    return (
        <div className="demo-page">
            ...
            <DemoSection title="基础用法" description="加载成功时显示图片，加载过程中自动展示占位动画">
            ...
            <DemoSection title="状态切换" description="通过 src 属性控制不同的展示状态">
                <div className="demo-row">
            ...
            <DemoSection title="不同尺寸" description="通过容器尺寸控制图片显示大小，组件自动适配">
            ...
            <DemoSection title="懒加载" description={"组件默认开启 loading=\"lazy\"，也可手动覆盖"}>
                <div className="demo-row">
                    <div style={makeBox(400, 300)}>
            ...
            <DemoSection title="patchImgLoader 函数版" description="返回 HTML 字符串，适用于非 React 环境或模板拼接场景">
                <div className="demo-row">
                    <div
